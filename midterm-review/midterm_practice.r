...
set.seed(42)
nmat <- matrix(c(rnorm(10000,mean=6,sd=2)), nrow=100, ncol=100, byrow=F)
...
plot(infants$gestation, infants$birthweight, xlab='gestation', ylab='birthweight')
